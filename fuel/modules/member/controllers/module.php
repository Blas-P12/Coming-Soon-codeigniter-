...
//echo FUEL_FOLDER;
	...
	function replace($id = NULL)
	{
		...
		$fields['fuel_replace_id'] = array('label' => 'Replace record:', 'type' => 'select', 'options' => $other_options, 'first_option' => 'Select record to replace...', 'style' => 'max-width: 600px', 'disabled_options' => array($id));
