...
<form enctype="multipart/form-data"  method="post" action="<?php echo base_url(); ?>fuel/property/admin/allotmember/<?php echo $designationid ?>/<?php echo $propertyid ?>">
    ...
    <div id="fuel_main_content">
            ...
            <div id="form" class="">
                <table id="vTab" align="center" border="0" width="36%" style="margin: auto;">
                    <tr>
                        ...
                        <td width="100%" style="font-size: 14px;color:#000;"><b>Allot members to : <?php echo $designationdetail[0]["name"]; ?> </b></td>
                    </tr>    
                    <tr>
        ...
        <?php
        echo anchor('fuel/property/admin/freemember/' . $allotmemberdetail["id"] . '/' . $designationid . '/' . $propertyid . '', 'Remove', 'class="btn" ');
        ?>
                                                 <!--<a class="btn" href="<?php base_url() ?>property/admin/freemember/<?php echo $allotmemberdetail["id"] ?>/<?php echo $designationid ?>/<?php echo $propertyid ?>">Free</a>&nbsp;-->
                                                </td>
                                            </tr>
        <?php
    }
