...
<input type="hidden"  name="id" value="<?php echo $evacuationrptdetails["id"];?>">
...
<tr>
	...
	<td class="value"><input type="text" required="" size="40" maxlength="200" value="<?php echo $evacuationrptdetails["name"];?>" id="name" name="name">
